      ...
      <!-- Main content -->
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-lg-4 col-6">
                                <div class="small-box bg-danger">
                                    <div class="inner" v-if="Bureau.bureauaffiliates">
                                        <h3>{{Bureau.bureauaffiliates.length}}</h3>
                                        <p>Affiliates </p>
                                    </div>
                                    <div class="icon">
        ...
        <div class="modal fade " id="BureauModal" tabindex="-1" role="dialog" aria-labelledby="BureauModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form role="form" @submit.prevent="editmodeBureau ? updateBureau(bureauform.id) : addBureau ()" >
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="logo" class=" col-form-label">Bureau Logo</label><br>
                                            <input @change="bureauChangeLogo($event)" type="file" name="logo"
                                                ...
                                                <img  v-show="!editmodeBureau" :src="bureauLoadLogo(bureauform.logo)" alt="" width="100%" >
                        ...
                        <div class="modal-footer">
                            ...
                            <button v-show="editmodeBureau" type="submit" class="btn btn-success">Update</button>
                            <button v-show="!editmodeBureau" type="submit" class="btn btn-primary">Create</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade " id="DirectorsModal" tabindex="-1" role="dialog" aria-labelledby="DirectorsModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title"  id="DirectorsModalLabel">Bureau Directors</h3>
                        <span>
        ...
        <div class="modal fade " id="AdminsModal" tabindex="-1" role="dialog" aria-labelledby="AdminsModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title"  id="AdminsModalLabel">Bureau Admins</h3>
                        <span>
      ...
      <!-- create & edit Admin modal -->
        ...
        <div class="modal fade " id="EmployeesModal" tabindex="-1" role="dialog" aria-labelledby="EmployeesModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title"  id="EmployeesModalLabel">Bureau Employees</h3>
                        <span>
...
<script>
    ...
    export default {
        ...
        computed:{
            backgroundImage(){
                 let Image = false;
                 if(Image = true){
                        this.imageUrl = "/assets/bureau/img/background/"+Image;
                    }else{
            ...
            Employee(){
               return this.$store.getters.BureauEmployee//reminder to updater index
            },
        },
        methods:{
            // phone and landline
 ...
 //Affiliate
            ...
            loadBureau(){
                return this.$store.dispatch( "bureauByUserID")//get all from bureau. bureau linked to user
            },
                    ...
                    this.$Progress.start();
                      axios.get('/api/bureau/edit/'+id)
                        .then((response)=>{
                            ...
                            console.log(response.data.bureau,'organisa')
                            this.bureauform.id =  response.data.bureau.id
                            this.bureauform.name =  response.data.bureau.name
                            this.bureauform.bureau_email =  response.data.bureau.bureau_email
                            this.bureauform.phone =  response.data.bureau.phone
                            this.bureauform.landline =  response.data.bureau.landline
                            this.bureauform.website =  response.data.bureau.website
                            this.bureauform.address =  response.data.bureau.address
                            this.bureauform.logo =  response.data.bureau.logo
            ...
            deleteBureau(id){
                ...
                .then((result) => {
                    ...
                    //  console.log('delete user', id)
                        this.$Progress.start();
                        this.bureauform.get('/api/bureau/delete/'+id)
                            .then(()=>{
                            toast({
                            type: 'success',
            ...
            AffiliatesModal(){
                ...
                this.$store.dispatch( "bureauByUserID")
                    .then((response)=>{
                       ...
                       toast({
                        type: 'success',
                        title: 'Fetched the Bureau Afiliates data successfully'
                        })
                        this.$Progress.finish();
                    })
                    .catch(()=>{
                      ...
                      axios.get('/api/bureaudirector/edit/'+id)
                        .then((response)=>{
                           ...
                           toast({
                            ...
                            this.directorform.bureau_id = response.data.user.bureaudirectors[0].pivot.bureau_id
                      ...
                      axios.get('/api/bureauadmin/edit/'+id)
                        .then((response)=>{
                           ...
                           toast({
                            ...
                            this.adminform.bureau_id = response.data.user.bureauadmins[0].pivot.bureau_id
                      ...
                      axios.get('/api/bureauemployee/edit/'+id)
                        .then((response)=>{
                           ...
                           toast({
                            ...
                            this.employeeform.bureau_id = response.data.user.bureauemployees[0].pivot.bureau_id
