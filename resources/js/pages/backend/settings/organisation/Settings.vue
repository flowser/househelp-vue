...
<script>
 ...
 //Affiliate
            ...
            validateOrganisation() {
                this.$Progress.start()
                return this.organisationform.post('/api/organisation/verify/info')
                    .then((response)=>{
                        return true;
                        toast({
                            type: 'success',
            ...
            validateDirector() {
                ...
                return this.organisationform.post('/api/organisation/verify/director')
                    .then((response)=>{
                        return true;
                        toast({
                            type: 'success',
            ...
            validateOrganisationUpdate() {
                ...
                this.$Progress.start()
                return this.organisationform.patch('/api/organisation/updateverify/info/'+id)
                    .then((response)=>{
                        return true;
                        toast({
                            type: 'success',
            ...
            validateDirectorUpdate() {
                ...
                // this.organisationOutput = this.organisationform;  //append form data
                return this.organisationform.patch('/api/organisation/updateverify/director/'+id)
                    .then((response)=>{
                        return true;
                        toast({
                            type: 'success',
            ...
            addOrganisation(){
                ...
                this.$Progress.start();
                this.organisationform.post('/api/organisation')
                    .then((response)=>{
                         toast({
                            type: 'success',
            ...
            updateOrganisation(id){
                  ...
                  this.$Progress.start();
                     this.organisationform.patch('/api/organisation/update/'+id)
                        .then(()=>{
            ...
            deleteOrganisation(id){
                ...
                .then((result) => {
                    ...
                    //  console.log('delete user', id)
                        this.$Progress.start();
                        this.organisationform.get('/api/organisation/delete/'+id)
                            .then(()=>{
                            toast({
                            type: 'success',
            ...
            deleteDirector(id){
                ...
                .then((result) => {
                    ...
                    //  console.log('delete director', id)
                        this.$Progress.start();
                        this.directorform.get('/api/orgdirector/delete/'+id)
                            .then(()=>{
                            toast({
                            type: 'success',
            ...
            addAdmin(Organisation_id) {
                console.log(Organisation_id)
                this.$Progress.start();
                this.adminform.patch('/api/orgadmin/'+Organisation_id)
                    .then((response)=>{
                        //  console.log(response.data)
                         toast({
                            type: 'success',
            ...
            deleteAdmin(id){
                ...
                .then((result) => {
                    ...
                    //  console.log('delete admin', id)
                        this.$Progress.start();
                        this.adminform.get('/api/orgadmin/delete/'+id)
                            .then(()=>{
                            toast({
                            type: 'success',
            ...
            deleteEmployee(id){
                ...
                .then((result) => {
                    ...
                    //  console.log('delete employee', id)
                        this.$Progress.start();
                        this.employeeform.get('/api/orgemployee/delete/'+id)
                            .then(()=>{
                            toast({
                            type: 'success',
            ...
            updateAbout(id){
                  ...
                  this.$Progress.start();
                     this.aboutform.patch('/api/about/update/'+id)
                        .then(()=>{
                             this.$store.dispatch( "organisation")
                            this.$store.dispatch( "about")
                            this.$store.dispatch( "services")
            ...
            addService() {
                ...
                this.$Progress.start();
                this.serviceform.post('/api/service')
                    .then((response)=>{
                        //  console.log(response.data)
                         toast({
                            type: 'success',
            ...
            updateService(id){
                  ...
                  this.$Progress.start();
                     this.serviceform.patch('/api/service/update/'+id)
                        .then(()=>{
                            this.$store.dispatch( "organisation")
                            this.$store.dispatch( "about")
                            this.$store.dispatch( "services")
            ...
            addAdvert() {
                ...
                this.$Progress.start();
                this.advertform.post('/api/advert')
                    .then((response)=>{
                        //  console.log(response.data)
                         toast({
                            type: 'success',
            ...
            updateAdvert(id){
                  ...
                  this.$Progress.start();
                     this.advertform.patch('/api/advert/update/'+id)
                        .then(()=>{
                            this.$store.dispatch( "organisation")
                            this.$store.dispatch( "about")
                            this.$store.dispatch( "services")
            ...
            deleteAdvert(id){
                ...
                .then((result) => {
                    ...
                    //  console.log('delete user', id)
                        this.$Progress.start();
                        this.advertform.get('/api/advert/delete/'+id)
                            .then(()=>{
                            toast({
                            type: 'success',
            ...
            addFeature() {
                ...
                this.$Progress.start();
                this.featureform.post('/api/feature')
                    .then((response)=>{
                        //  console.log(response.data)
                         toast({
                            type: 'success',
            ...
            updateFeature(id){
                  ...
                  this.$Progress.start();
                     this.featureform.patch('/api/feature/update/'+id)
                        .then(()=>{
                            this.$store.dispatch( "organisation")
                            this.$store.dispatch( "about")
                            this.$store.dispatch( "services")
            ...
            deleteFeature(id){
                ...
                .then((result) => {
                    ...
                    //  console.log('delete user', id)
                        this.$Progress.start();
                        this.featureform.get('/api/feature/delete/'+id)
                            .then(()=>{
                            toast({
                            type: 'success',
            ...
            editServiceModelModal(id){
                 ...
                 this.servicemodelform.reset()
                   console.log('edit servicemodel', id)
                    this.$Progress.start();
                      axios.get('/api/servicemodel/edit/'+id)
            ...
            addServiceModel() {
                ...
                this.$Progress.start();
                this.servicemodelform.post('/api/servicemodel')
                    .then((response)=>{
                        //  console.log(response.data)
                         toast({
                            type: 'success',
            ...
            updateServiceModel(id){
                  ...
                  this.$Progress.start();
                     this.servicemodelform.patch('/api/servicemodel/update/'+id)
                        .then(()=>{
                            this.$store.dispatch( "organisation")
                            this.$store.dispatch( "about")
                            this.$store.dispatch( "services")
            ...
            deleteServiceModel(id){
                ...
                .then((result) => {
                    ...
                    //  console.log('delete user', id)
                        this.$Progress.start();
                        this.servicemodelform.get('/api/servicemodel/delete/'+id)
                            .then(()=>{
                            toast({
                            type: 'success',
