...
// import LeftSideBar from "../includes/frontend/LeftSidebar.vue";
    export default {
       ...
       mounted(){
        ...
        methods:{
            // singleabout(){
            //     this.$store.dispatch('aboutById', this.$route.params.id);
            // },
            // aboutLoadImage(about_image){
            //     if(about_image){
            //         return "/assets/organisation/img/abouts/"+about_image;
            //     }else{
            //         return "/assets/organisation/img/website/empty.png";
            //     }
            // },
            // aboutCodeImage(codepen_ic_png){
            //     if(codepen_ic_png){
            ...
            //     }
            // },
            // aboutDurationImage(clock_ic_png){
            //     if(clock_ic_png){
            ...
            //     }
            // },
            // aboutaboutStudentsImage(user_ic_png){
            //     if(user_ic_png){
            ...
            // },
            // RegularEnroll(about){
            //      this.enrollform.fill(about);
            //      this.enrollform.aboutType = "Regular";
            //      if(this.enrollform.aboutType == "Regular"){
            ...
            //             type: 'error',
            //             type: 'error',
            //             title: 'about Alreaday exist in your cart'
            //         })
            //     })
            // },
            // ParttimeEnroll(about){
            //     this.enrollform.fill(about);
            //     this.enrollform.aboutType = "Parttime";
            //     if(this.enrollform.aboutType == "Parttime"){
            ...
            //         toast({
            //             type: 'error',
            //             title: 'about Alreday exist in your cart'
            //         })
            //     })
            // },
            // Remove(cartItem_id){
            ...
            //          toast({
            //             type: 'success',
            //             title: 'about Removed successful'
            //             })
            //             this.loadabouts()
            //             this.loadCartItems()
            //               this.$Progress.finish()
            ...
            //         toast({
            //             type: 'error',
            //             title: 'about Removal not successful.'
            //         })
            //     })
            // },
            // Clear(CartItems){
            ...
            //          toast({
            //             type: 'success',
            //             title: 'about Cart was Cleared successful'
            //             })
            //             this.loadabouts()
            //             this.loadCartItems()
            //               this.$Progress.finish()
            ...
            //         toast({
            //             type: 'error',
            //             title: 'about Cart was not Cleared successful.'
            //         })
            //     })
            // },
