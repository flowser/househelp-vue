...
// import LeftSideBar from "../includes/frontend/LeftSidebar.vue";
    export default {
       ...
       mounted(){
        ...
        methods:{
            // singlePolicies(){
            //     this.$store.dispatch('PoliciesById', this.$route.params.id);
            // },
            // PoliciesLoadImage(Policies_image){
            //     if(Policies_image){
            //         return "/assets/organisation/img/Policiess/"+Policies_image;
            //     }else{
            //         return "/assets/organisation/img/website/empty.png";
            //     }
            // },
            // PoliciesCodeImage(codepen_ic_png){
            //     if(codepen_ic_png){
            ...
            //     }
            // },
            // PoliciesPriceImage(dolar_ic_png){
            //      if(dolar_ic_png){
            ...
            //     }
            // },
            // PoliciesLessonsImage(cup_ic_png){
            //    if(cup_ic_png){
            ...
            //     }
            // },
            // PoliciesDurationImage(clock_ic_png){
            //     if(clock_ic_png){
            ...
            //     }
            // },
            // PoliciesPoliciesStudentsImage(user_ic_png){
            //     if(user_ic_png){
            ...
            //     }
            // },
            // RegularEnroll(Policies){
            //      this.enrollform.fill(Policies);
            //      this.enrollform.PoliciesType = "Regular";
            //      if(this.enrollform.PoliciesType == "Regular"){
            ...
            //             type: 'error',
            //             type: 'error',
            //             title: 'Policies Alreaday exist in your cart'
            //         })
            //     })
            // },
            // ParttimeEnroll(Policies){
            //     this.enrollform.fill(Policies);
            //     this.enrollform.PoliciesType = "Parttime";
            //     if(this.enrollform.PoliciesType == "Parttime"){
            ...
            //         toast({
            //             type: 'error',
            //             title: 'Policies Alreday exist in your cart'
            //         })
            //     })
            // },
            // Remove(cartItem_id){
            ...
            //          toast({
            //             type: 'success',
            //             title: 'Policies Removed successful'
            //             })
            //             this.loadPoliciess()
            //             this.loadCartItems()
            //               this.$Progress.finish()
            ...
            //         toast({
            //             type: 'error',
            //             title: 'Policies Removal not successful.'
            //         })
            //     })
            // },
            // Clear(CartItems){
            ...
            //          toast({
            //             type: 'success',
            //             title: 'Policies Cart was Cleared successful'
            //             })
            //             this.loadPoliciess()
            //             this.loadCartItems()
            //               this.$Progress.finish()
            ...
            //         toast({
            //             type: 'error',
            //             title: 'Policies Cart was not Cleared successful.'
            //         })
            //     })
            // },
