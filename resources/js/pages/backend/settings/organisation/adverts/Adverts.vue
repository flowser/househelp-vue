...
// import LeftSideBar from "../includes/frontend/LeftSidebar.vue";
    export default {
       ...
       mounted(){
        ...
        methods:{
            // singleAdverts(){
            //     this.$store.dispatch('AdvertsById', this.$route.params.id);
            // },
            // AdvertsLoadImage(Adverts_image){
            //     if(Adverts_image){
            //         return "/assets/organisation/img/Advertss/"+Adverts_image;
            //     }else{
            //         return "/assets/organisation/img/website/empty.png";
            //     }
            // },
            // AdvertsCodeImage(codepen_ic_png){
            //     if(codepen_ic_png){
            ...
            //     }
            // },
            // AdvertsPriceImage(dolar_ic_png){
            //      if(dolar_ic_png){
            ...
            //     }
            // },
            // AdvertsLessonsImage(cup_ic_png){
            //    if(cup_ic_png){
            ...
            //     }
            // },
            // AdvertsDurationImage(clock_ic_png){
            //     if(clock_ic_png){
            ...
            //     }
            // },
            // AdvertsAdvertsStudentsImage(user_ic_png){
            //     if(user_ic_png){
            ...
            //     }
            // },
            // RegularEnroll(Adverts){
            //      this.enrollform.fill(Adverts);
            //      this.enrollform.AdvertsType = "Regular";
            //      if(this.enrollform.AdvertsType == "Regular"){
            ...
            //             type: 'error',
            //             type: 'error',
            //             title: 'Adverts Alreaday exist in your cart'
            //         })
            //     })
            // },
            // ParttimeEnroll(Adverts){
            //     this.enrollform.fill(Adverts);
            //     this.enrollform.AdvertsType = "Parttime";
            //     if(this.enrollform.AdvertsType == "Parttime"){
            ...
            //         toast({
            //             type: 'error',
            //             title: 'Adverts Alreday exist in your cart'
            //         })
            //     })
            // },
            // Remove(cartItem_id){
            ...
            //          toast({
            //             type: 'success',
            //             title: 'Adverts Removed successful'
            //             })
            //             this.loadAdvertss()
            //             this.loadCartItems()
            //               this.$Progress.finish()
            ...
            //         toast({
            //             type: 'error',
            //             title: 'Adverts Removal not successful.'
            //         })
            //     })
            // },
            // Clear(CartItems){
            ...
            //          toast({
            //             type: 'success',
            //             title: 'Adverts Cart was Cleared successful'
            //             })
            //             this.loadAdvertss()
            //             this.loadCartItems()
            //               this.$Progress.finish()
            ...
            //         toast({
            //             type: 'error',
            //             title: 'Adverts Cart was not Cleared successful.'
            //         })
            //     })
            // },
