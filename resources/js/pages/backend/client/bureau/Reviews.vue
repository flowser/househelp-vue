                    ...
                    <td style="padding: 3px; width:130px" >
                        ...
                        <div class="clearfix" style="font-weight:bold;font-size:0.7em;">
                            <span class="float-left">
                                <router-link  :to="`/B/househelp/${househelp.id}`">
    ...
    export default {
        ...
        methods:{
            ...
            validateHousehelpDemograhic() {
                ...
                this.$Progress.start()
                return this.househelp_kinform.post('/api/househelp/verify/demographics')
                    .then((response)=>{
                        return true;
                        toast({
                            type: 'success',
            ...
            validateHousehelpkin() {
                this.$Progress.start()
                return this.househelp_kinform.post('/api/househelp/verify/kin')
                    .then((response)=>{
                        return true;
                        toast({
                            type: 'success',
            ...
            addHousehelp(Bureau_id) {
                ...
                this.$Progress.start();
                this.househelp_kinform.patch('/api/househelp/'+Bureau_id)
                    .then((response)=>{
