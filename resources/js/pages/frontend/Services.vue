...
// import LeftSideBar from "../includes/frontend/LeftSidebar.vue";
    export default {
       ...
       mounted(){
        ...
        methods:{
            // singleServices(){
            //     this.$store.dispatch('ServicesById', this.$route.params.id);
            // },
            // ServicesLoadImage(Services_image){
            //     if(Services_image){
            //         return "/assets/organisation/img/Servicess/"+Services_image;
            //     }else{
            //         return "/assets/organisation/img/website/empty.png";
            //     }
            // },
            // ServicesCodeImage(codepen_ic_png){
            //     if(codepen_ic_png){
            ...
            //     }
            // },
            // ServicesPriceImage(dolar_ic_png){
            //      if(dolar_ic_png){
            ...
            //     }
            // },
            // ServicesLessonsImage(cup_ic_png){
            //    if(cup_ic_png){
            ...
            //     }
            // },
            // ServicesDurationImage(clock_ic_png){
            //     if(clock_ic_png){
            ...
            //     }
            // },
            // ServicesServicesStudentsImage(user_ic_png){
            //     if(user_ic_png){
            ...
            //     }
            // },
            // RegularEnroll(Services){
            //      this.enrollform.fill(Services);
            //      this.enrollform.ServicesType = "Regular";
            //      if(this.enrollform.ServicesType == "Regular"){
            ...
            //             type: 'error',
            //             type: 'error',
            //             title: 'Services Alreaday exist in your cart'
            //         })
            //     })
            // },
            // ParttimeEnroll(Services){
            //     this.enrollform.fill(Services);
            //     this.enrollform.ServicesType = "Parttime";
            //     if(this.enrollform.ServicesType == "Parttime"){
            ...
            //         toast({
            //             type: 'error',
            //             title: 'Services Alreday exist in your cart'
            //         })
            //     })
            // },
            // Remove(cartItem_id){
            ...
            //          toast({
            //             type: 'success',
            //             title: 'Services Removed successful'
            //             })
            //             this.loadServicess()
            //             this.loadCartItems()
            //               this.$Progress.finish()
            ...
            //         toast({
            //             type: 'error',
            //             title: 'Services Removal not successful.'
            //         })
            //     })
            // },
            // Clear(CartItems){
            ...
            //          toast({
            //             type: 'success',
            //             title: 'Services Cart was Cleared successful'
            //             })
            //             this.loadServicess()
            //             this.loadCartItems()
            //               this.$Progress.finish()
            ...
            //         toast({
            //             type: 'error',
            //             title: 'Services Cart was not Cleared successful.'
            //         })
            //     })
            // },
