...
// import LeftSideBar from "../includes/frontend/LeftSidebar.vue";
    export default {
       ...
       mounted(){
        ...
        methods:{
            // singleRefund(){
            //     this.$store.dispatch('RefundById', this.$route.params.id);
            // },
            // RefundLoadImage(Refund_image){
            //     if(Refund_image){
            //         return "/assets/organisation/img/Refunds/"+Refund_image;
            //     }else{
            //         return "/assets/organisation/img/website/empty.png";
            //     }
            // },
            // RefundCodeImage(codepen_ic_png){
            //     if(codepen_ic_png){
            ...
            //     }
            // },
            // RefundDurationImage(clock_ic_png){
            //     if(clock_ic_png){
            ...
            //     }
            // },
            // RefundRefundStudentsImage(user_ic_png){
            //     if(user_ic_png){
            ...
            //     }
            // },
            // RegularEnroll(Refund){
            //      this.enrollform.fill(Refund);
            //      this.enrollform.RefundType = "Regular";
            //      if(this.enrollform.RefundType == "Regular"){
            ...
            //             type: 'error',
            //             type: 'error',
            //             title: 'Refund Alreaday exist in your cart'
            //         })
            //     })
            // },
            // ParttimeEnroll(Refund){
            //     this.enrollform.fill(Refund);
            //     this.enrollform.RefundType = "Parttime";
            //     if(this.enrollform.RefundType == "Parttime"){
            ...
            //         toast({
            //             type: 'error',
            //             title: 'Refund Alreday exist in your cart'
            //         })
            //     })
            // },
            // Remove(cartItem_id){
            ...
            //          toast({
            //             type: 'success',
            //             title: 'Refund Removed successful'
            //             })
            //             this.loadRefunds()
            //             this.loadCartItems()
            //               this.$Progress.finish()
            ...
            //         toast({
            //             type: 'error',
            //             title: 'Refund Removal not successful.'
            //         })
            //     })
            // },
            // Clear(CartItems){
            ...
            //          toast({
            //             type: 'success',
            //             title: 'Refund Cart was Cleared successful'
            //             })
            //             this.loadRefunds()
            //             this.loadCartItems()
            //               this.$Progress.finish()
            ...
            //         toast({
            //             type: 'error',
            //             title: 'Refund Cart was not Cleared successful.'
            //         })
            //     })
            // },
