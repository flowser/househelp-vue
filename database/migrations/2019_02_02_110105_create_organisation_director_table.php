...
class CreateOrganisationDirectorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('organisation_director', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('organisation_director');
    }
}
